...
// ************************************************************************* //
//                            avtFLASHXFileFormat.h                           //
// ************************************************************************* //

#ifndef AVT_FLASHX_FILE_FORMAT_H
#define AVT_FLASHX_FILE_FORMAT_H
...
// ****************************************************************************
//  Class: avtFLASHXFileFormat
//
//  Purpose:
//      Reads in FLASHX files as a plugin to VisIt.
//
...
//    Added methods and structs to support for FLASHX3 formats.
//
...
class avtFLASHXFileFormat : public avtSTMDFileFormat
{
  public:
                       avtFLASHXFileFormat(const char *, const DBOptionsAttributes *);
    virtual           ~avtFLASHXFileFormat();

    virtual bool           HasInvariantMetaData(void) const { return false; };
    virtual bool           HasInvariantSIL(void) const { return false; };

    virtual const char    *GetType(void)   { return "FLASHX"; };
  ...
  protected:
    ...
    // FLASHX3 support
    void ReadParticleAttributes_FLASHX3();
  ...
  protected:
    ...
    //  Since 2 "file format version"s (FFV) for FLASHX3, need to read "sim info" 
  ...
  protected:
    ...
    std::vector<int>          visitIdToFLASHXId;
    std::vector<int>          FLASHXIdToVisitId;
    bool                      showProcessors;
    bool                      newStyleCurves;
